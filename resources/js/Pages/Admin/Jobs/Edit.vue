...
const submit = () => {
    form.put(route('admin.jobs.update', job.data.id), {
...
<template>
    <Head :title="`Edit: ${job.data.title}`" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Job</h2>
        </template>
