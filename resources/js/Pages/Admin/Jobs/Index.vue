...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">All Jobs</h2>
        </template>
                            ...
                            <tbody>
                                <template v-if="jobs.data.length">
                                    <tr v-for="job in jobs.data"
                                        class="border-b bg-white hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600">
