                ...
                <div class="py-24 sm:py-32 lg:pb-40">
                    <div class="px-6 mx-auto max-w-7xl lg:px-8">
                        <div class="max-w-2xl mx-auto text-center">
                            ...
                            <form class="mt-10" @submit.prevent="getSearch" method="GET">
                ...
                <div class="grid grid-cols-12 lg:gap-12">
                    <div class="col-span-12" id="find-job">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <p class="text-base text-white/60">{{ jobCount }}
                                Result{{ jobs.data.length > 1 ? 's' : '' }} Found</p>
                        </div>
                        <!-- /Section Header -->
                        <!-- Job Listings -->
                        <div>
                                ...
                                <div v-for="job in jobs.data"
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex flex-col items-start gap-6 md:flex-row md:items-center">
                                            <img :alt="job.company_name" loading="lazy"
                                                class="w-16 h-16 p-2 bg-gray-700 rounded-xl" style="color: transparent"
                                        ...
                                        <Link
                                            ...
                                            :href="route('frontend.job_details', job.id)" as="button">
                                        View Job
                                        <span>
                                    ...
                                    <p class="mt-5 text-base text-white/60 line-clamp-2">
                                        {{ job.description }}
                                    </p>
                                </div>
                                <!-- /Job Card -->
                            ...
                            <template v-else>
                                <h4 class="my-4 text-center text-xl font-semibold text-white/80">
                                    No Job Posted Yet. Come Back Later 👋
                                </h4>
                            </template>
                        </div>
                        <!-- /Job Listings -->
...
const { jobs, jobCount, searchQuery } = usePage().props

const form = useForm({
    search: searchQuery,
})

const getSearch = () => form.get("/")
</script>
