      ...
      ">
                ...
                <div class="px-4 py-10 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between max-w-2xl mx-auto lg:mx-0 lg:max-w-none">
                        <Link :href="route('frontend.home')" type="button"
                    ...
                    <div class="flex items-center justify-between max-w-2xl mx-auto gap-x-8 lg:mx-0 lg:max-w-none">
                        <div class="flex flex-col items-start md:flex-row gap-x-6">
                            <img :src="job.data.company_logo" :alt="job.data.company_name"
                        ...
                        <div
                            ...
                            <dl class="flex flex-wrap gap-4 mb-6">
                                ...
                                <div class="flex flex-none w-full gap-x-4">
                                    ...
                                    <dd class="text-sm leading-6 text-gray-300">
                                        <time datetime="2023-01-31">{{ job.data.created_at }}</time>
                                    </dd>
                                </div>
                            </dl>

                            <a :href="job.data.apply_url"
